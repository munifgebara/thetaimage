...
import static br.com.munif.learn.phd.domain.UsuarioAsserts.*;
...
import br.com.munif.learn.phd.repository.UsuarioRepository;
...
class UsuarioResourceIT {
    ...
    private static final TipoUsuario DEFAULT_TIPO = TipoUsuario.ADMINISTRADOR;
    private static final TipoUsuario UPDATED_TIPO = TipoUsuario.USUARIO;
    ...
    public static Usuario createEntity() {
        return new Usuario().nome(DEFAULT_NOME).email(DEFAULT_EMAIL).senha(DEFAULT_SENHA).tipo(DEFAULT_TIPO);
    }
    ...
    public static Usuario createUpdatedEntity() {
        return new Usuario().nome(UPDATED_NOME).email(UPDATED_EMAIL).senha(UPDATED_SENHA).tipo(UPDATED_TIPO);
    }
    ...
    void putExistingUsuario() throws Exception {
        ...
        updatedUsuario.nome(UPDATED_NOME).email(UPDATED_EMAIL).senha(UPDATED_SENHA).tipo(UPDATED_TIPO);
    ...
    void partialUpdateUsuarioWithPatch() throws Exception {
        ...
        partialUpdatedUsuario.email(UPDATED_EMAIL).senha(UPDATED_SENHA);
    ...
    void fullUpdateUsuarioWithPatch() throws Exception {
        ...
        partialUpdatedUsuario.nome(UPDATED_NOME).email(UPDATED_EMAIL).senha(UPDATED_SENHA).tipo(UPDATED_TIPO);
