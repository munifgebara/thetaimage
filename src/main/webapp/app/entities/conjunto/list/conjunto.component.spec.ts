...
import { sampleWithRequiredData } from '../conjunto.test-samples';
import { ConjuntoService } from '../service/conjunto.service';

import { ConjuntoComponent } from './conjunto.component';
import SpyInstance = jest.SpyInstance;

describe('Conjunto Management Component', () => {
  let comp: ConjuntoComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(ConjuntoComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.conjuntos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to conjuntoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getConjuntoIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getConjuntoIdentifier).toHaveBeenCalledWith(entity);
