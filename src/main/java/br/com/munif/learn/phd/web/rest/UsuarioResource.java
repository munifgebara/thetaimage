...
/**
 * REST controller for managing {@link br.com.munif.learn.phd.domain.Usuario}.
 */
@RestController
...
public class UsuarioResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<Usuario>> getAllUsuarios(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
